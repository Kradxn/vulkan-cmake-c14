...
libpng-dev libxcb-dri3-dev libx11-dev libmirclient-dev libwayland-dev libxrandr-dev libxinerama-dev libxcursor-dev libglfw3-dev libglu1-mesa-dev --fix-missing && \
