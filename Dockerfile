...
RUN apt-get update && \
	apt-get install -y cmake git gcc g++ wget xz-utils libxcb-dri3-0 libxcb-present0 libpciaccess0 libxcb-dri3-dev libx11-dev libxrandr-dev libmirclient-dev libglu1-mesa-dev --fix-missing && \
